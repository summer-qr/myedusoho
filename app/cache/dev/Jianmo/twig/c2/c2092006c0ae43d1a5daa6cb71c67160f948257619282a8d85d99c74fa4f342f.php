...
class __TwigTemplate_afb6b63a070fb32cea084f6c0639048e2de286b9db28f716f14c23d18b83efd3 extends Twig_Template
{
    ...
    {
        $__internal_8952061c3cb3b1a4a2521186f6669206b8fefde15a69870f477b8c007b098ba1 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_8952061c3cb3b1a4a2521186f6669206b8fefde15a69870f477b8c007b098ba1->enter($__internal_8952061c3cb3b1a4a2521186f6669206b8fefde15a69870f477b8c007b098ba1_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "default/index.html.twig"));
        ...
        $__internal_8952061c3cb3b1a4a2521186f6669206b8fefde15a69870f477b8c007b098ba1->leave($__internal_8952061c3cb3b1a4a2521186f6669206b8fefde15a69870f477b8c007b098ba1_prof);
    ...
    {
        $__internal_b203153ae6fc3573bbe690d118ea84a03e416f6224e3bf33360d21b5a4f428cc = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_b203153ae6fc3573bbe690d118ea84a03e416f6224e3bf33360d21b5a4f428cc->enter($__internal_b203153ae6fc3573bbe690d118ea84a03e416f6224e3bf33360d21b5a4f428cc_prof = new Twig_Profiler_Profile($this->getTemplateName(), "block", "content"));
    ...
    ";
        ...
        ";
            // line 17
            if (((isset($context["isPlugin"]) ? $context["isPlugin"] : $this->getContext($context, "isPlugin")) && $this->env->getExtension('AppBundle\Twig\WebExtension')->isPluginInstalled($this->getAttribute($context["config"], "pluginName", array())))) {
                // line 18
                echo "          ";
                $this->loadTemplate($this->getAttribute($context["config"], "show", array()), "default/index.html.twig", 18)->display(array_merge($context, array("config" => $context["config"], "category" => (isset($context["category"]) ? $context["category"] : $this->getContext($context, "category")))));
                // line 19
                echo "        ";
            } elseif ( !(isset($context["isPlugin"]) ? $context["isPlugin"] : $this->getContext($context, "isPlugin"))) {
                // line 20
                echo "          ";
                if (((isset($context["code"]) ? $context["code"] : $this->getContext($context, "code")) == "friend-link")) {
                    // line 21
                    echo "              ";
                    $this->loadTemplate((("default/" . (isset($context["code"]) ? $context["code"] : $this->getContext($context, "code"))) . ".html.twig"), "default/index.html.twig", 21)->display(array_merge($context, array("friendlyLinks" => (isset($context["friendlyLinks"]) ? $context["friendlyLinks"] : $this->getContext($context, "friendlyLinks")))));
                    // line 22
                    echo "          ";
                    ...
                    if (((isset($context["code"]) ? $context["code"] : $this->getContext($context, "code")) != "course-grid-with-condition-index")) {
                        ...
                        if ($asm89CacheBody2 === false) {
                            ob_start();
                                // line 25
                                echo "                  ";
                                $this->loadTemplate((("default/" . (isset($context["code"]) ? $context["code"] : $this->getContext($context, "code"))) . ".html.twig"), "default/index.html.twig", 25)->display(array_merge($context, array("config" => $context["config"], "category" => (isset($context["category"]) ? $context["category"] : $this->getContext($context, "category")))));
                                // line 26
                                echo "                  ";
                        ...
                        // line 28
                        echo "                  ";
                        $this->loadTemplate((("default/" . (isset($context["code"]) ? $context["code"] : $this->getContext($context, "code"))) . ".html.twig"), "default/index.html.twig", 28)->display(array_merge($context, array("config" => $context["config"], "category" => (isset($context["category"]) ? $context["category"] : $this->getContext($context, "category")))));
                        // line 29
                        echo "              ";
                    }
                    // line 30
    ...
    ";
        ...
        $__internal_b203153ae6fc3573bbe690d118ea84a03e416f6224e3bf33360d21b5a4f428cc->leave($__internal_b203153ae6fc3573bbe690d118ea84a03e416f6224e3bf33360d21b5a4f428cc_prof);
...
{% block content %}
    ...
    {% endfor %}
{% endblock %}", "default/index.html.twig", "D:\\phpStudy\\PHPTutorial\\WWW\\edusoho\\app\\Resources\\views\\default\\index.html.twig");
    }
}
