...
class __TwigTemplate_bd2154c5ca0101df29cc32ecf4dcdbfc258647527e10acdb45d4268799421596 extends Twig_Template
{
  ...
  ";
        ...
        if (((isset($context["orderBy"]) ? $context["orderBy"] : null) == "latest")) {
            ...
            // line 12
            echo "  ";
        } elseif (((isset($context["orderBy"]) ? $context["orderBy"] : null) == "hotSeq")) {
            // line 13
            echo "    ";
            $context["courseSets"] = $this->env->getExtension('AppBundle\Twig\DataExtension')->getData("PopularCourseSets", array("count" => (isset($context["count"]) ? $context["count"] : null), "categoryId" => (isset($context["categoryId"]) ? $context["categoryId"] : null), "type" => "hotSeq"));
            // line 14
            echo "  ";
        }
        // line 15
    ...
    <div class=\"course-filter\" id=\"course-filter\">
      ...
      <div class=\"course-sort btn-group\">
        ...
        <a href=\"javascript:;\"
           class=\"btn btn-default ";
        // line 86
        if ((((array_key_exists("orderBy", $context)) ? (_twig_default_filter((isset($context["orderBy"]) ? $context["orderBy"] : null), "recommendedSeq")) : ("recommendedSeq")) == "hotSeq")) {
            echo " active ";
        }
        echo "js-course-filter\"
           data-url=\"";
        // line 87
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("homepage_category", array("categoryId" => ((array_key_exists("categoryId", $context)) ? (_twig_default_filter((isset($context["categoryId"]) ? $context["categoryId"] : null), 0)) : (0)), "orderBy" => "hotSeq")), "html", null, true);
        echo "\"
           data-type='course'>
          ";
        // line 89
...
";
    ...
    {
        return new Twig_Source("", "default/course-grid-with-condition-index.html.twig", "D:\\phpStudy\\PHPTutorial\\WWW\\edusoho\\app\\Resources\\views\\default\\course-grid-with-condition-index.html.twig");
    }
}
