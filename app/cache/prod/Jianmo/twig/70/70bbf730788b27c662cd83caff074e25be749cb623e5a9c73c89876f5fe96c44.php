...
class __TwigTemplate_af6c3d55929b6c3c6aa7088f782df2175e2a3115c098b764a9677f97d82ad767 extends Twig_Template
{
    ...
    {
        // line 1
        if (($this->env->getExtension('AppBundle\Twig\PermissionExtension')->hasPermission("admin") || twig_in_filter("ROLE_TEACHER", $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()), "roles", array())))) {
            // line 2
    ...
    <a class=\"btn cd-btn user-manage-toggle\" href=\"javascript:;\">";
            ...
            } elseif (twig_in_filter("ROLE_TEACHER", $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()), "roles", array()))) {
...
";
    ...
    {
        return new Twig_Source("", "default/header/part/user-role-manage.html.twig", "D:\\phpStudy\\PHPTutorial\\WWW\\edusoho\\app\\Resources\\views\\default\\header\\part\\user-role-manage.html.twig");
    }
}
