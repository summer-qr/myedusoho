...
class __TwigTemplate_b915686673ebb11ea3bf931a9853fbfd7d664f288df0a05779557ce992d79be3 extends Twig_Template
{
    ...
    ";
        ...
        ";
            // line 17
            if (((isset($context["isPlugin"]) ? $context["isPlugin"] : null) && $this->env->getExtension('AppBundle\Twig\WebExtension')->isPluginInstalled($this->getAttribute($context["config"], "pluginName", array())))) {
                // line 18
                echo "          ";
                $this->loadTemplate($this->getAttribute($context["config"], "show", array()), "default/index.html.twig", 18)->display(array_merge($context, array("config" => $context["config"], "category" => (isset($context["category"]) ? $context["category"] : null))));
                // line 19
                echo "        ";
            } elseif ( !(isset($context["isPlugin"]) ? $context["isPlugin"] : null)) {
                // line 20
                echo "          ";
                if (((isset($context["code"]) ? $context["code"] : null) == "friend-link")) {
                    // line 21
                    echo "              ";
                    $this->loadTemplate((("default/" . (isset($context["code"]) ? $context["code"] : null)) . ".html.twig"), "default/index.html.twig", 21)->display(array_merge($context, array("friendlyLinks" => (isset($context["friendlyLinks"]) ? $context["friendlyLinks"] : null))));
                    // line 22
                    echo "          ";
                    ...
                    if (((isset($context["code"]) ? $context["code"] : null) != "course-grid-with-condition-index")) {
                        ...
                        if ($asm89CacheBody2 === false) {
                            ob_start();
                                // line 25
                                echo "                  ";
                                $this->loadTemplate((("default/" . (isset($context["code"]) ? $context["code"] : null)) . ".html.twig"), "default/index.html.twig", 25)->display(array_merge($context, array("config" => $context["config"], "category" => (isset($context["category"]) ? $context["category"] : null))));
                                // line 26
                                echo "                  ";
                        ...
                        // line 28
                        echo "                  ";
                        $this->loadTemplate((("default/" . (isset($context["code"]) ? $context["code"] : null)) . ".html.twig"), "default/index.html.twig", 28)->display(array_merge($context, array("config" => $context["config"], "category" => (isset($context["category"]) ? $context["category"] : null))));
                        // line 29
                        echo "              ";
                    }
                    // line 30
    ...
    {
        return new Twig_Source("", "default/index.html.twig", "D:\\phpStudy\\PHPTutorial\\WWW\\edusoho\\app\\Resources\\views\\default\\index.html.twig");
    }
}
