...
class __TwigTemplate_6e28bd9c48f258d25d8bfab8a88eeecd401b7d62e5b69bc4795dea861bf97333 extends Twig_Template
{
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["courseSet"]) {
              ...
              ";
                  ...
                  <div class=\"date\">
                    ";
                    // line 30
                    echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["task"]) ? $context["task"] : null), "startTime", array()), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("site.date_format")), "html", null, true);
                    echo "
                  </div>
                </div>
              ";
...
";
    ...
    {
        return new Twig_Source("", "default/live-course.html.twig", "D:\\phpStudy\\PHPTutorial\\WWW\\edusoho\\app\\Resources\\views\\default\\live-course.html.twig");
    }
}
