...
class __TwigTemplate_72b547a3e28341609f22fd253a551480bff2cff4d815a0bd6530e27f34afeb7e extends Twig_Template
{
  ...
  <div class=\"dropdown-menu user-dropdown hidden-sm hidden-xs hidden-md js-user-nav-dropdown\">
    <div class=\"user-dropdown-info cd-mb24\">
      ...
      <div class=\"user-dropdown-profile\">
        ...
        echo "</span>";
        echo $this->env->getExtension('Codeages\PluginBundle\Twig\SlotExtension')->slot("header.user.logo", array("user" => $this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array())));
        echo "
        </div>
        ";
        // line 14
        echo $this->env->getExtension('Codeages\PluginBundle\Twig\SlotExtension')->slot("header.user.info", array("user" => $this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array())));
        echo "
      </div>
    </div>
  ...
  <ul class=\"dropdown-menu hidden-lg\" role=\"menu\">
    ...
    {
        return new Twig_Source("", "default/header/part/user-avatar.html.twig", "D:\\phpStudy\\PHPTutorial\\WWW\\edusoho\\app\\Resources\\views\\default\\header\\part\\user-avatar.html.twig");
    }
}
