...
class __TwigTemplate_09fb183fd4f62660ec851b7638e19bbc432fd9f5a6b8804217de0084ea015236 extends Twig_Template
{
  ...
  <div class=\"metas\">";
        // line 17
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("classroom.courses_count", array("%courseNum%" => sprintf("<span>%d</span>", $this->getAttribute((isset($context["classroom"]) ? $context["classroom"] : null), "courseNum", array()))));
        echo "</div>
</div>
";
    }
    ...
    {
        return new Twig_Source("", "classroom/class-grid.html.twig", "D:\\phpStudy\\PHPTutorial\\WWW\\edusoho\\app\\Resources\\views\\classroom\\class-grid.html.twig");
    }
}
